...
export function EmissionsDonut({ byCategoryAnnual }) {
  const total = Data.CATEGORY_ORDER.reduce(
    (sum, key) => sum + byCategoryAnnual[key],
    0,
  );
      ...
      datasets: [
        {
          ...
          backgroundColor: Data.CATEGORY_ORDER.map(
            (key) => CATEGORY_COLORS[key],
          ),
          borderWidth: 2,
    ...
    <div className="emissions-donut">
      <div className="emissions-donut__chart">
        ...
        <div className="emissions-donut__center">
          <span className="emissions-donut__center-value">
        ...
        {Data.CATEGORY_ORDER.map((key) => {
          ...
          return (
            <li key={key} className="emissions-legend__item">
              <span
                className="emissions-legend__dot"
              ...
              <Icon
                size={14}
                aria-hidden="true"
                className="emissions-legend__icon"
              />
              <span className="emissions-legend__label">
