  ...
  return (
    <div className="kpi-grid">
      ...
      <article className="kpi-card kpi-card--comparison">
        ...
        <p
          className={`kpi-card__value kpi-card__value--small ${comparison.below ? "kpi-card__value--good" : "kpi-card__value--bad"}`}
        >
          {comparison.below ? (
        ...
        <p className="kpi-card__hint">
          {comparison.below ? "below" : "above"} the global average
        </p>
      </article>
    </div>
  );
