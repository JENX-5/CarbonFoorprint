...
export const CALCULATOR_STEPS = [
  {
    ...
    fields: [
      {
        name: "vehicleType",
        label: "Main commute vehicle",
        type: "select",
        optionsKey: "VEHICLE_LABELS",
      },
      {
      ...
      {
        name: "flightsLongHaulPerYear",
        label: "Long-haul flights / yr",
        type: "number",
        min: 0,
        max: 100,
        half: true,
  ...
  },
  {
    ...
    fields: [
      {
        name: "dietType",
        label: "Overall dietary pattern",
        type: "select",
        optionsKey: "DIET_LABELS",
      },
    ],
  },
  {
    ...
    fields: [
      ...
      {
        name: "waterHeatedMostly",
        label: "Most of this water is heated",
        type: "checkbox",
      },
    ],
  },
