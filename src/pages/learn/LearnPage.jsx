  ...
  return (
    <div className="learn-page">
      ...
      <div style={{ marginTop: '2rem' }}>
        <p className="section__intro" style={{ marginBottom: '1.5rem', color: 'var(--color-charcoal-soft)' }}>
          Tips are sorted to prioritize your highest emission category once you compute your footprint. Feel free to browse any area below.
        </p>
        ...
        <div className="tabs">
          ...
          >
            {Data.SUSTAINABILITY_TIPS[activeTab]?.map((tip, i) => (
              <article key={i} className="tip-card" style={{
                ...
                <h4 className="tip-card__title" style={{
                ...
                <p className="tip-card__desc" style={{
                  margin: 0,
                  fontSize: '0.92rem',
